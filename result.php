    ...
    <div class="container">
        ...
        <p>&nbsp;</p>
                ...
                ?>
                  <ul class="list-group">
                        ...
                        <li class="list-group-item">Age<strong> :<?php echo $visit['age']; ?></strong></li>
                     
                        <li class="list-group-item">Temperature<strong> :<?php echo $visit['temp']; ?></strong></li>
                     
                        <li class="list-group-item">Heighr<strong> :<?php echo $visit['height']; ?></strong></li>
                      
                        <li class="list-group-item"><strong> Doctors Notes </strong></li>
                        
                        <li class="list-group-item"><textarea style="resize:none"><?php echo $visit['notes']; ?></textarea></li>

                        <li class="list-group-item"><strong> Symptoms </strong></li>
                        
                        <li class="list-group-item"><textarea style="resize:none"><?php echo $visit['symptoms']; ?></textarea></li>

                        <li class="list-group-item"><strong> Laboratory Notes </strong></li>
                        
                        <li class="list-group-item"><textarea style="resize:none"><?php echo $visit['labnote']; ?></textarea></li>
      ...
      <table width="400">
                ...
                <tr>
                  ...
                  <td> <?php echo $visit['test1']; ?></td>
                  <td> <?php echo $visit['result1']; ?></td>
                </tr>
                <tr>
                  <th scope="row">TEST 2</th>
                  <td> <?php echo $visit['test2']; ?></td>
                  <td><?php echo $visit['result2']; ?></td>
                </tr>
                <tr>
                  <th scope="row">TEST 3</th>
                  <td> <?php echo $visit['test3']; ?></td>
                  <td><?php echo $visit['result3']; ?></td>
                </tr>
              </table>
        
      </li>
    <li class="list-group-item"><a href="labprescription.php?ID=<?php echo $visit['ID']; ?>">PRESCRIBE DRUGS</a></li>
...
<table width="350" border="0">
    ...
    ?> 
        ...
        <ul class="nav nav-pills nav-stacked">
          ...
          <form action="result.php?ID=<?php echo $visit['ID']; ?>" method="post">
          <ul class="list-group">
          <li class="list-group-item" > <label class="alert alert-info">Prescription for <?php echo ucwords($visit['name']); ?></label></li>
          <input type="hidden" name="visit_id" value=" <?php echo $visit['visit_id']; ?>"/>
          <li class="list-group-item" > <textarea style="resize:none" name="prescribe" id="prescribe" placeholder="write prescription here"> </textarea> </li>
          <li class="list-group-item" > <input name="submit" type="submit" value=" Submit prescription "> </li>
          </ul>
          </form>
