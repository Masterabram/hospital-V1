...
<!-- getting the id from doctor categoy -->
...
<?php
   if (isset($_POST['update_visit'])){
     ...
     $query = "UPDATE visits SET symptoms='{$symptoms}', notes='{$notes}', doctor='{$doctor}' ";
     $query .= "WHERE visit_id ='{$visit_id}' ";
      ...
      redirect_to('prescription.php?visit_id='.$visit_id);
    }
...
<body>
    ...
    <div class="container">
        ...
        <p>&nbsp;</p>
                ...
                <?php  
                 $visit = mysqli_fetch_assoc(find_doctor($visit_id));
     ...
     <form class="navbar-form" method="post" action="drview.php?visit_id=<?php echo $visit['visit_id']; ?>" >
        <table width="300" class="table table-striped">
                  <tr>
                    <input type="hidden" value="<?php echo $visit['visit_id']; ?>" name="visit_id" />
                    <input type="hidden" name="doctor" value="<?php echo $_SESSION['name']; ?>" >
                    <td>Patient Synmptoms</td>
                  </tr>
                  <tr>
                    <td><textarea style="resize:none;" cols="45" row="5" name="symptoms" wrap="hard" id="symptoms" required></textarea></td>
                  </tr>
                  <tr>
                    <td>Doctor's notes</td>
                  </tr>
                  <tr>
                    <td><textarea cols="45" style="resize:none;" row="5" name="notes" wrap="hard" id="symptoms" required></textarea></td>
                  </tr>
                </table>
            <p>
                        <script>
            ...
            <table width="300" border="0">
              <tr>
                <td width="143"><input name="update_visit" type="submit" id="" class="btn btn-primary btn-block"  value="Prescribe/Refer"></td>
                <td width="141"></td>
              </tr>
            </table>
     </form>
                  ...
                  <ul class="list-group">
                    <li class="list-group-item">
                      ...
                      <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="resultset.php">Laboratory results <span class="badge pull-right">7</span></a></li>
                                    <li><a href="account.php">My account</a></li>
