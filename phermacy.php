...
<head>
    ...
    <title>CHEMISTS DEPERTMENT</title>
...
<body>
        ...
        <div class="container">
            ...
            <div style="float:right" class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="phermacy.php"> <span class="glyphicon glyphicon-home"></span> HOME</a></li>
    ...
    <form class="navbar-form">
        <p>&nbsp;</p>
         <form class="navbar-form" >
          ...
          <table width="700" class="table-striped" align="centre">
            <tr>
              ...
              <th width="100">checked</th>
                 ...
                 <?php
                  ...
                  ?>
                    <tr>
                      <td width="200"><a href="phermview.php?visit_id=<?php echo $visit['visit_id']; ?>"> <?php echo ($visit['ID']); ?> </a></td>
    ...
    <?php
      $pages = ceil(mysqli_num_rows(find_pherms(0, $current_page)) / 15);
      for($page=1;$page<=$pages;$page++){
    ?>
      <a href="phermacy.php?page=<?php echo $page?>"><?php echo $page; ?></a>
    <?php
      }
    ?>
