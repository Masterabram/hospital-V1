...
<body>
    ...
    <form class="navbar-form">
        <p>&nbsp;</p>
         <form class="navbar-form" >
          ...
          <table width="700" border="0" class="table-striped" align="centre">
                 ...
                 <?php
                    $visit_set = find_doctors(1, $current_page);
                  // pre($patient_set);
                    while($visit = mysqli_fetch_assoc($visit_set)){
                  ?>
                    <tr>
                      <td width="200"><a href="drview.php?visit_id=<?php echo $visit['visit_id']; ?>"> <?php echo ($visit['ID']); ?> </a></td>
        ...
        <hr>
    <?php
      $pages = ceil(mysqli_num_rows(find_doctors(0, $current_page)) / 20);
      for($page=1;$page<=$pages;$page++){
    ?>
      <a href="doctor.php?page=<?php echo $page?>"><?php echo $page; ?></a>
    <?php
      }
    ?>
    <hr>
            ...
            <div class="col-md-4">
                <div class="alert alert-info"><?php
                    ...
                    <ul class="nav nav-pills nav-stacked">
                      <li class="active"><a href="doctor.php"> <span class="glyphicon glyphicon-home"> </span> Home </a></li>
